...
export const blogs: BlogMeta[] = [
  {
    ...
    title: 'Agentic Coding Essentials Week 1: Learning about skills',
    description:
      "I'd never used Claude skills before this week. Turns out they're a way to teach Claude how to do the repetitive things in your project — and the process I want to follow for creating them borrows directly from TDD.",
    date: '2026-04-07',
    image:
