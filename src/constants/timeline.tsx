export const timeline = [
  {
    company: 'Freelance / Sub-contractor',
  ...
  },
  {
    ...
    date: 'August 2024',
    technologies: ['React', 'MedusaJS'],
    responsibilities: [
      'Implement improvements to the shopping cart and checkout workflow for the CoShop website',
    ],
  },
  {
    company: '~ TRAVEL BREAK ~',
    title: 'Travel and yoga teacher training',
    date: 'June 2024 - July 2024',
    responsibilities: [
      "I took this time to work on my yoga and meditation practice for my personal and emotional growth. Since completing my training, I've realised positive changes in how I approach professional challenges, manage stress and prioritise connection.",
    ],
  },
  {
    company: 'Devart',
    title: 'Full Stack Developer and Innovation Lead',
