...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className="fixed lg:hidden top-4 right-4 h-8 w-8 border-1 bg-tropical-indigo-200 border-tropical-indigo-400 rounded-full backdrop-blur-sm shadow-sm flex items-center justify-center z-50"
